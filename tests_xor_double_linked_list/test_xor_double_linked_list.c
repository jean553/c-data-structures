...
{
    XorDoubleLinkedList first_list = create(0);
...
START_TEST(test_insertAtTheBeginning)
{
    ...
    XorDoubleLinkedList second_list = create(0);
...
START_TEST(test_insertAt)
{
    ...
    XorDoubleLinkedList second_list = create(10);
    ...
    XorDoubleLinkedList third_list = create(10);
    ...
    XorDoubleLinkedList fourth_list = create(10);
    ...
    XorDoubleLinkedList fifth_list = create(10);
